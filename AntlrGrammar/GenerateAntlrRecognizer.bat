...
REM *  antlr complete jar. Lasts used was 4.6.0. In theory, latest antlr v4 will work.
...
REM *  ./tsql.g4 (already in git; originally taken from  https://github.com/antlr/grammars-v4/blob/master/tsql/tsql.g4)
REM 
